    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text("MyPomodoro", style: GoogleFonts.abrilFatface(textStyle: const TextStyle(color: Colors.red, fontSize: 35)),),
          ...
          SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed:(){
                   Navigator.push(context, MaterialPageRoute(builder: (content)=> const HomePage()));
